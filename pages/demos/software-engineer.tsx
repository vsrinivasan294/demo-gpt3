...
const conversationStart = `GPT responds to the user in a engineering first point of view.

GPT=Hey Software Engineer, type in your question regarding code?`;
...
export default function Chatbot() {
  const form = useForm<FormValues>({
    initialValues: {
      input: "Hey, do you have some code for me to play with?",
    },
    validate: {
