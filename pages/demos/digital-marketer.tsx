...
const conversationStart = `GPT responds to the user in a marketing first tone of voice.

GPT=How can I help you acheive your kpis`;
...
export default function Chatbot() {
  const form = useForm<FormValues>({
    initialValues: {
      input: "What are we trying to maximize?",
    },
    validate: {
